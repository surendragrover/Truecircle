...
/// BreathingSampleDataService
/// Loads breathing exercise sample data from the `Demo_data` asset folder.
class BreathingSampleDataService {
  ...
  static Future<List<Map<String, dynamic>>> getBreathingData() async {
    ...
    try {
      // Load from JSON file in Demo_data folder (asset folder name retained for now)
