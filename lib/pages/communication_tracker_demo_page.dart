// lib/pages/communication_tracker_demo_page.dart
...
class CommunicationTrackerDemoPage extends StatefulWidget {
  const CommunicationTrackerDemoPage({super.key});

  @override
  State<CommunicationTrackerDemoPage> createState() => _CommunicationTrackerDemoPageState();
}

class _CommunicationTrackerDemoPageState extends State<CommunicationTrackerDemoPage> 
  ...
  String _selectedContact = 'demo_contact_1';
  
  final Map<String, String> _demoContacts = {
    'demo_contact_1': 'Alex Johnson',
    'demo_contact_2': 'Sarah Williams', 
    'demo_contact_3': 'Mike Chen',
  };
  ...
  void _initializeServices() {
    try {
      ...
      debugPrint('✅ Communication Tracker: Privacy Service loaded');
    } catch (e) {
      debugPrint('❌ Communication Tracker: Privacy Service not available: $e');
    }
  }
  ...
  Future<void> _loadCommunicationData() async {
    ...
    try {
      ...
      debugPrint('✅ Communication Tracker: Loaded ${logs.length} logs');
    } catch (e) {
      debugPrint('❌ Communication Tracker: Error loading data: $e');
  ...
  Future<void> _generateRelationshipInsight() async {
    ...
    try {
      ...
      debugPrint('✅ Communication Tracker: Generated relationship insight');
    } catch (e) {
      debugPrint('❌ Communication Tracker: Error generating insight: $e');
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Communication Tracker Demo'),
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(
                      ...
                      labelText: 'Demo Contact',
                    ),
                    items: _demoContacts.entries.map((entry) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPermissionRow('Communication Tracking', true, 'Demo Mode'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'This demo uses sample communication data to demonstrate relationship insights while maintaining complete privacy. In real usage, all analysis would happen on-device with your actual communication patterns, ensuring your personal data never leaves your device.',
